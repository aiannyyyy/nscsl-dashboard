            ...
            {[1, 2, 3, 4].map((n) => (
              <div key={n} className="col-span-12 md:col-span-3">
                ...
                >
                  ...
                  <option value="CONTAMINATED DUE TO WHITE PATCHES">CONTAMINATED DUE TO WHITE PATCHES</option>
                  <option value="CONTAMINATED WET">CONTAMINATED WET</option>
                  <option value="DELAYED INITIAL COLLECTION">DELAYED INITIAL COLLECTION</option>
                  <option value="CONTAMINATED SERUM RINGS">CONTAMINATED SERUM RINGS</option>
                  <option value="POSSIBLE DATA SWITCHING">POSSIBLE DATA SWITCHING</option>
