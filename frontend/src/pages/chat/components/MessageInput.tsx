    ...
    <div className="px-3 py-2.5 border-t border-slate-100 bg-white flex-shrink-0">
      ...
      <form onSubmit={handleSubmit} className="flex items-center gap-2">
        ...
        <input
          ...
          className="flex-1 bg-slate-100 rounded-full px-3.5 py-2 text-xs text-slate-800 placeholder-slate-400 outline-none focus:ring-2 focus:ring-blue-500/20 transition"
        />
